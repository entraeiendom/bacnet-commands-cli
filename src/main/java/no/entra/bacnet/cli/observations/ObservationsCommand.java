...
@CommandLine.Command(name = "observations",
        subcommands = {SubscribeObservationsCommand.class, CancelSubscriptionsObservationsCommand.class, AcknowledgeObservationReceivedCommand.class, CommandLine.HelpCommand.class},
